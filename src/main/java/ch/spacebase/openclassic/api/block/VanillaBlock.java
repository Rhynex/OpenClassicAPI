...
public final class VanillaBlock {
	...
	public static final BlockType GRASS = new BlockType(2, StepSound.GRASS, new CubeModel(BlockType.TERRAIN, new int[] { 2, 0, 3, 3, 3, 3 })).setSelectable(false);
	public static final BlockType DIRT = new BlockType(3, StepSound.DIRT, 2);
	...
	public static final BlockType SAND = new BlockType(12, StepSound.SAND, 18);
	public static final BlockType GRAVEL = new BlockType(13, StepSound.GRAVEL, 19);
	...
	public static final BlockType LOG = new BlockType(17, StepSound.WOOD, new CubeModel(BlockType.TERRAIN, new int[] { 21, 21, 20, 20, 20, 20 }));
	public static final BlockType LEAVES = new BlockType(18, StepSound.GRASS, 22).setOpaque(false);
	public static final BlockType SPONGE = new BlockType(19, StepSound.GRASS, 48);
	public static final BlockType GLASS = new BlockType(20, StepSound.METAL, 49).setOpaque(false);
	public static final BlockType RED_CLOTH = new BlockType(21, StepSound.CLOTH, 64);
	public static final BlockType ORANGE_CLOTH = new BlockType(21, 1, StepSound.CLOTH, 65);
	public static final BlockType YELLOW_CLOTH = new BlockType(21, 2, StepSound.CLOTH, 66);
	public static final BlockType LIME_CLOTH = new BlockType(21, 3, StepSound.CLOTH, 67);
	public static final BlockType GREEN_CLOTH = new BlockType(21, 4, StepSound.CLOTH, 68);
	public static final BlockType AQUA_GREEN_CLOTH = new BlockType(21, 5, StepSound.CLOTH, 69);
	public static final BlockType CYAN_CLOTH = new BlockType(21, 6, StepSound.CLOTH, 70);
	public static final BlockType BLUE_CLOTH = new BlockType(21, 7, StepSound.CLOTH, 71);
	public static final BlockType PURPLE_CLOTH = new BlockType(21, 8, StepSound.CLOTH, 72);
	public static final BlockType INDIGO_CLOTH = new BlockType(21, 9, StepSound.CLOTH, 73);
	public static final BlockType VIOLET_CLOTH = new BlockType(21, 10, StepSound.CLOTH, 74);
	public static final BlockType MAGENTA_CLOTH = new BlockType(21, 11, StepSound.CLOTH, 75);
	public static final BlockType PINK_CLOTH = new BlockType(21, 12, StepSound.CLOTH, 76);
	public static final BlockType BLACK_CLOTH = new BlockType(21, 13, StepSound.CLOTH, 77);
	public static final BlockType GRAY_CLOTH = new BlockType(21, 14, StepSound.CLOTH, 78);
	public static final BlockType WHITE_CLOTH = new BlockType(21, 15, StepSound.CLOTH, 79);
	public static final BlockType SANDSTONE = new BlockType(22, StepSound.STONE, new CubeModel(BlockType.TERRAIN, new int[] { 57, 25, 41, 41, 41, 41 }));
	public static final BlockType CACTUS = new BlockType(23, StepSound.CLOTH, new CactusModel(BlockType.TERRAIN, new int[] { 47, 45, 46, 46, 46, 46 })); // TODO: model
	...
	public static final BlockType GOLD_BLOCK = new BlockType(41, StepSound.METAL, new CubeModel(BlockType.TERRAIN, new int[] { 56, 24, 40, 40, 40, 40 }));
	public static final BlockType IRON_BLOCK = new BlockType(42, StepSound.METAL, new CubeModel(BlockType.TERRAIN, new int[] { 55, 23, 39, 39, 39, 39 }));
	public static final BlockType DOUBLE_SLAB = new BlockType(43, StepSound.STONE, new CubeModel(BlockType.TERRAIN, new int[] { 6, 6, 5, 5, 5, 5 })).setSelectable(false);
	public static final BlockType SLAB = new BlockType(44, StepSound.STONE, new CuboidModel(BlockType.TERRAIN, new int[] { 6, 6, 5, 5, 5, 5 }, 0, 0, 0, 1, 0.5F, 1));
	...
	public static final BlockType BOOKSHELF = new BlockType(47, StepSound.WOOD, new CubeModel(BlockType.TERRAIN, new int[] { 4, 4, 35, 35, 35, 35 }));
