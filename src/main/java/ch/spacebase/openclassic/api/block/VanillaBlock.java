...
import ch.spacebase.openclassic.api.block.physics.HalfBlockPhysics;
...
public class VanillaBlock {
	...
	public static final BlockType WATER = new BlockType(8, StepSound.NONE, new LiquidModel(BlockType.TERRAIN_TEXTURE, 14)).setTickDelay(5).setLiquid(true).setPreventsRendering(false).setSelectable(false).setPlaceIn(true).setFogDensity(0.1f).setFogColor(5, 5, 51).setSpeedModifier(0.8f);
	public static final BlockType STATIONARY_WATER = new BlockType(9, StepSound.NONE, new LiquidModel(BlockType.TERRAIN_TEXTURE, 14)).setLiquid(true).setPreventsRendering(false).setSelectable(false).setPlaceIn(true).setFogDensity(0.1f).setFogColor(5, 5, 51).setSpeedModifier(0.8f);
	public static final BlockType LAVA = new BlockType(10, StepSound.NONE, new LiquidModel(BlockType.TERRAIN_TEXTURE, 30)).setTickDelay(20).setLiquid(true).setPreventsRendering(false).setSelectable(false).setPlaceIn(true).setBrightness(1).setFogDensity(2).setFogColor(153, 26, 0).setSpeedModifier(0.5f);
	public static final BlockType STATIONARY_LAVA = new BlockType(11, StepSound.NONE, new LiquidModel(BlockType.TERRAIN_TEXTURE, 30)).setLiquid(true).setPreventsRendering(false).setSelectable(false).setPlaceIn(true).setBrightness(1).setFogDensity(2).setFogColor(153, 26, 0).setSpeedModifier(0.5f);
	...
	public static final BlockType DANDELION = new BlockType(37, StepSound.GRASS, new PlantModel(BlockType.TERRAIN_TEXTURE, 13)).setOpaque(false).setPreventsRendering(false);
	public static final BlockType ROSE = new BlockType(38, StepSound.GRASS, new PlantModel(BlockType.TERRAIN_TEXTURE, 12)).setOpaque(false).setPreventsRendering(false);
	public static final BlockType BROWN_MUSHROOM = new BlockType(39, StepSound.GRASS, new PlantModel(BlockType.TERRAIN_TEXTURE, 29)).setOpaque(false).setPreventsRendering(false);
	public static final BlockType RED_MUSHROOM = new BlockType(40, StepSound.GRASS, new PlantModel(BlockType.TERRAIN_TEXTURE, 28)).setOpaque(false).setPreventsRendering(false);
	...
	public static final BlockType SLAB = new BlockType(44, StepSound.STONE, new CuboidModel(BlockType.TERRAIN_TEXTURE, new int[] { 6, 6, 5, 5, 5, 5 }, 0, 0, 0, 1, 0.5F, 1)).setPreventsRendering(false);
	...
	public static void registerAll() {
		try {
			for(Field f : VanillaBlock.class.getDeclaredFields()) {
				Blocks.register((BlockType) f.get(null)); 
			}
		} catch(Exception e) {
