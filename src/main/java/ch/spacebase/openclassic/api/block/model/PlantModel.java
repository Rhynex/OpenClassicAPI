...
public class PlantModel extends Model {
	...
	public PlantModel(Texture texture, int textureId) {
		...
		Quad face1 = QuadFactory.getFactory().newQuad(0, texture.getSubTexture(textureId));
		...
		Quad face2 = QuadFactory.getFactory().newQuad(2, texture.getSubTexture(textureId));
