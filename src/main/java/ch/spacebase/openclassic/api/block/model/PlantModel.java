...
public class PlantModel extends Model {
	...
	public PlantModel(Texture texture, int textureId) {
		...
		Quad face1 = QuadFactory.getFactory().newQuad(this.quadCount, texture.getSubTexture(textureId));
		...
		Quad face2 = QuadFactory.getFactory().newQuad(this.quadCount, texture.getSubTexture(textureId));
	...
	public void addQuad(Quad quad) {
		...
		Quad q = QuadFactory.getFactory().newQuad(this.quadCount, quad.getTexture());
